...
\item [{[G\ped{1}]}]	A user wants to go to a meeting.
\item [{[G\ped{2}]}]	A user wants to arrive on time to a meeting.
\item [{[G\ped{3}]}]	A user wants to have a break that has a certain duration between two meetings.
\item [{[G\ped{4}]}]	The time or the location of a meeting can be modified.

\item [{[G\ped{5}]}]  A user does not want to go any more to a meeting.
...
\item [{[G\ped{8}]}] A user always wants to have a break between two specific times and with a minimum duration.
\item [{[G\ped{9}]}] A user wants to minimize carbon footprint when he/she goes to a meeting.
\item [{[G\ped{10}]}] A user wants to know every possible option to go to a meeting with different travel means in order to choose the suitable one.
%\item [{[G\ped{7}]}]	 provide constraints on different travel means;
\item [{[G\ped{11}]}]	A user wants to buy public transportation tickets or day/week/season pass basing on his/her needs.
