...
ambientalista con footprint (global constraint), break in giorno specifico e viene indirizzato alla pagina dei ristoranti (Cracco), the weather forecast, strike (un concorrente di XFactor),  bike sharing che indirizza al sito/app e playstore, account registration (Trump), 
...
ambientalista con footprint (global constraint), the weather forecast, strike (un concorrente di XFactor),  bike sharing che indirizza al sito/app e playstore
