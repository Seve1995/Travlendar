...
Every time the system is updated with the information about the traffic, the weather, strikes ecc. The user can either receive the respective notification or visualize all the warnings in the main screen.All this warnings influence the choice of the travel means for the trip. 
...
Leonardo Di Caprio is a famous actor that has always been active in fighting climate change. To raise awareness among the people about the environmental problems, he has the idea to live stream one of his ordinary day to show people the importance of using means of transport that minimize carbon footprint. 
